...
class Order
{
     ...
     */
    public function  __construct($direction, $property, $ignoreCase = null, NullHandling $nullHandling = null) {
        
        Assert::isTrue(StringUtils::hasText($property), "Property must not blank !");
        $direction = $direction instanceof  Direction ? $direction : new Direction($direction);
        $this->direction = $direction;
        $this->property = $property;
        $this->ignoreCase = (bool) ( $ignoreCase === null ? self::$DEFAULT_IGNORE_CASE : $ignoreCase );
        $this->nullHandling = null == $nullHandling ? NullHandling::NATIVE() : $nullHandling;
    }
