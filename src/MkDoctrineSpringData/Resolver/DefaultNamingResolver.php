...
use MkDoctrineSpringData\Exception\UnableResolvingRepositoryException;
class DefaultNamingResolver implements NamingResolverInterface
{
    ...
    public function resolveEntityName($repositoryInterfaceName)
    {
        ...
        throw new UnableResolvingRepositoryException(sprintf('Unable to resolve repositoryInterface[%s] to entity name', $repositoryInterfaceName));
    }
